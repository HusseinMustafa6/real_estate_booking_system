...
import 'package:real_estate/custom_widgets/binding_empty_request_card.dart';
import 'package:real_estate/modules/binding_charge_requests/Binding_charge_requests_controller.dart';
import 'package:real_estate/modules/binding_empty_requests/binding_empty_requests_controller.dart';

class BindingEmptyRequests  extends StatelessWidget {

  BindingEmptyRequestsController ctr = Get.put(BindingEmptyRequestsController());
                      ...
                      if(ctr.bindingList.isEmpty){
                        ...
                        return AlignedGridView.count(
                          ...
                          itemBuilder: (context, index) {
                            return BindingEmptyRequestCard(
